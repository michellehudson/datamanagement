...
\marginnote {michelle.hudson@yale.edu, kristin.bogdan@yale.edu}
...
There are four types of research data: \marginnote {Research data comes in many formats of information: documents,
...
\marginnote{\subsection{Guidelines for data collection \& documentation:}\label{guidelines-doc}
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\itemsep1pt\parskip0pt\parsep0pt
\item
...
\section{Data processing \& analysis}\label{data-processing-analysis} \marginnote {\subsection{Guidelines for data processing \& analysis:}\label{guidelines-processing}
...
preservation}\label{data-archiving-preservation} \marginnote{\subsection{Guidelines for data archiving \& preservation:}\label{guidelines-preservation}
...
citation}\label{data-distribution-citation} \marginnote {\subsection{Guidelines for data distribution \& citation:}\label{guidelines-citation}
